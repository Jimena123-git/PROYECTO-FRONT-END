...
<h2 class="tittle-crearCuenta mb-3 text-center">Registrarse</h2>
</div>
<form className="formUsuario" onSubmit={handleSubmit}>
<div className="mb-3">

<label htmlFor="usuario" className="form-label-usuario
fs-4">Usuario:</label>
<input
type="text"
id="usuario"
...
<p>&copy; 2025 Guardianes del Entorno. Todos los
